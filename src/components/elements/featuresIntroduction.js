...
function IntroFeature() {
  ...
  return (
    <div>
     ...
     <p style={lang === "ar" ? {textAlign: "end", marginRight: "6rem"}:{ marginLeft: "7rem", }} className="description-features-page">{description[0]}<br/>{description[1]}<a href='./features/start' style={{textDecoration: "none"}} className="a-btn-features"></a></p>
      </div>
     <SetInfoData />
      </div>
