...
function IntroFeature() {
  return (
    <div>
      <div>
      <h1 style={{color: "whitesmoke", fontSize: "4rem", margin: "70px 10px 20px 6rem"}} className="features-page-title">Start your Coding <br />Experience with<br />our Features</h1>
